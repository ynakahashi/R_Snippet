...
N_m_j_brd <- sum(pedigree_file$Will[pedigree_file$Generation == 0 && pedigree_file$Sex == "Male"])
N_f_j_brd <- sum(pedigree_file$Will[pedigree_file$Generation == 0 && pedigree_file$Sex == "Female"])
